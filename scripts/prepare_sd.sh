...
#Get device name
read -p "Please enter the target deivce name from list: pclcd-zynq, pclcd-lab-zynq, pclcd-lab-zynq1 [pclcd-zynq]: " DEVICE_NAME
...
case "$DEVICE_NAME" in
    ...
    "pclcd-lab-zynq"  ) mac="00:0A:35:00:01:23";;
